...
import com.famous.covid19detector.databinding.ActivityMaleriaBinding
import com.famous.covid19detector.databinding.ActivityQuestionBinding

class MaleriaActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityMaleriaBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMaleriaBinding.inflate(layoutInflater)
        setContentView(binding.root)

        val decide = arrayOf("", "Yes", "No")

        val arrayAdapter = ArrayAdapter(this, R.layout.simple_spinner_item, decide)
